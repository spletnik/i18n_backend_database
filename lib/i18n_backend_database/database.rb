  ...
  class Database
    ...
    def translate(locale, key, options = {})
      ...
      unless entry
        ...
        if (translation = @locale.translations.where("translations.key = ? AND translations.pluralization_index = ?" , Translation.hk(key), pluralization_index).last) and not translation.raw_key.starts_with?(key.to_s)
          translation = nil
        end
        unless translation
